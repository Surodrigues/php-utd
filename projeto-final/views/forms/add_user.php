...
<form action="<?=$GLOBALS['project_index'];?>/controllers/add_user.php" method="POST">
	<div class="row">
		...
		<div class="col-md-4">
			...
			<input type="text" name="user_phone" placeholder="Digite seu telefone" required class="form-control">
			<br><br>
		</div>

		<div class="col-md-4">
			<label> Celular: </label><br>
			<input type="text" name="user_cellphone" placeholder="Digite seu celular" required class="form-control">
			<br><br>
		</div>

		<div class="col-md-4">
			<label> Nascimento: </label><br>
			<input type="date" name="user_birth" placeholder="Digite a data de nascimento" required class="form-control">
			<br><br>
		</div>

		<div class="col-md-4">
			<label> Endereço: </label><br>
			<input type="text" name="user_address" placeholder="Digite seu endereço" required class="form-control">
			<br><br>
		</div>
